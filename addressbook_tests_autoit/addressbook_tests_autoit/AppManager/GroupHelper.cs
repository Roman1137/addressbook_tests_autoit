...
namespace addressbook_tests_autoit
{
    public class GroupHelper : HelperBase
    {
        ...
        public void Remove(int indexOfGroupToDelete)
        {
            OpenGroupsDialogue();
            aux.ControlTreeView
                (GROUPWINTITLE, "", "WindowsForms10.SysTreeView32.app.0.2c908d51", "Select", "#0|#"+ indexOfGroupToDelete, "");
            aux.ControlClick(GROUPWINTITLE, "", "WindowsForms10.BUTTON.app.0.2c908d51");
            WaitUntilPageIsReadyForUsage("Delete group");
